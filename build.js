...
const distFile = path.join(__dirname, 'timeflow-card.js');
...
`;
  ...
  console.log(` 5 Bundle created: ${distFile}`);
  console.log(` 4e6 Size: ${(fs.statSync(distFile).size / 1024).toFixed(2)} KB`);
  console.log(` 527 Processed ${processedFiles.size} files`);
}
 ...
 */
function watchFiles() {
  console.log(' 440 Watching for changes...');
    ...
    fs.readdirSync(dir).forEach(file => {
      ...
      if (stat.isDirectory()) {
        ...
        fs.watchFile(filePath, () => {
          console.log(` 4dd Changed: ${filePath}`);
          bundleFiles();
        });
      }
    });
